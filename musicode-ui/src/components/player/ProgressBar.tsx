...
export default function ProgressBar({ currentTime, duration, onSeek, trackId, waveformEnabled = false }: Props) {
  const progress = duration > 0 ? (currentTime / duration) * 100 : 0;
  const { peaks } = useWaveform(waveformEnabled ? trackId : undefined);

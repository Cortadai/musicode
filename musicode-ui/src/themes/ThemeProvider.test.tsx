...
describe('ThemeProvider', () => {
  ...
  it('reads stored shell and palette from localStorage', () => {
    mockLocalStorage.setItem('musicode-shell', 'nova');
    mockLocalStorage.setItem('musicode-palette', 'crimson');
  ...
  it('migrates legacy "novatouch" theme to nova shell', () => {
    mockLocalStorage.setItem('musicode-theme', 'novatouch');
    ...
    expect(captured!.themeName).toBe('nova');
    expect(mockLocalStorage.setItem).toHaveBeenCalledWith('musicode-shell', 'nova');
    expect(mockLocalStorage.removeItem).toHaveBeenCalledWith('musicode-theme');
  });
  ...
  it('setTheme changes shell and persists', () => {
    ...
    expect(mockLocalStorage.setItem).toHaveBeenCalledWith('musicode-shell', 'minimal');
  });
  ...
  it('setPalette changes palette and persists', () => {
    ...
    expect(mockLocalStorage.setItem).toHaveBeenCalledWith('musicode-palette', 'emerald');
  });
  ...
  it('falls back to defaults for invalid stored values', () => {
    mockLocalStorage.setItem('musicode-shell', 'nonexistent');
    mockLocalStorage.setItem('musicode-palette', 'bogus');

...
- [ ] **T01: AnalyzerDeckDataSource + useFrameScheduler** `est:30min`
...
- [ ] **T02: ScopeRenderer types + AnalyzerDeck container component** `est:45min`
...
- [ ] **T03: Spectrum Analyzer scope implementation** `est:60min`
...
- [ ] **T04: Shell integration + deck toggle** `est:45min`

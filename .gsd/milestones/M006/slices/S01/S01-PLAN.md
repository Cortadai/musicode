...
## Tasks
- [ ] **T01: Add SpringDoc dependency + Security config** — 1. Add springdoc-openapi-starter-webmvc-ui dependency to pom.xml
...
- [ ] **T02: Annotate controllers with OpenAPI descriptions** — 1. Add @Tag annotations to each controller with name and description
...
- [ ] **T03: Verify integration + run all tests** — 1. Start Spring Boot and verify /swagger-ui.html loads

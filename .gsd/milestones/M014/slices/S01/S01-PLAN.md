...
- [x] **T01: Health check DTOs y LibraryHealthService** `est:2h`
...
- [x] **T02: Repository queries custom para health checks** `est:1h`
...
- [x] **T03: REST endpoints y controller** `est:45min`
...
- [x] **T04: Tests de integración completos** `est:1h`

...
public class JwtService {
    ...
    public JwtService(
            @Value("${sonance.jwt.secret}") String secret,
            @Value("${sonance.jwt.access-token-expiration-ms:900000}") long accessTokenExpirationMs,
            @Value("${sonance.jwt.refresh-token-expiration-ms:604800000}") long refreshTokenExpirationMs) {

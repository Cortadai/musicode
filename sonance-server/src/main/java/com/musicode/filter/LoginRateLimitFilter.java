...
public class LoginRateLimitFilter extends OncePerRequestFilter {
    ...
    public LoginRateLimitFilter(
            @org.springframework.beans.factory.annotation.Value("${sonance.security.login-rate-limit.max-attempts:5}") int maxAttempts,
            @org.springframework.beans.factory.annotation.Value("${sonance.security.login-rate-limit.window-seconds:60}") long windowSeconds) {

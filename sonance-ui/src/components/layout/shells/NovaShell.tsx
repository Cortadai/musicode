  ...
  return (
    <div className="h-screen flex overflow-hidden relative" style={{ backgroundColor: 'var(--mc-bg-base)', color: 'var(--mc-text-primary)' }}>
      ...
      >
        ...
        <a href="https://github.com/Cortadai/sonance" target="_blank" rel="noopener noreferrer" aria-label="GitHub repository" className="mc-interactive-muted transition-colors">
      ...
      <div className="flex-1 flex flex-col min-w-0 relative z-[1]">
        <div className="electron-drag-strip" style={{ backgroundColor: 'var(--mc-bg-base)' }} />
